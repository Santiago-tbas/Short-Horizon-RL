...
class TruncatedGaussian:
    ...
    def __init__(self, mu, sigma=0.5, low=-1.0, high=1.0):
        # create a truncated Gaussian arm with specified mean, standard deviation, and bounds
        self.mean = mu
        self.sigma = sigma
        self.low = low
        self.high = high
    ...
    def sample(self):
        # generate a reward using rejection sampling
        while True:
            val = np.random.normal(self.mean, self.sigma)
