...
def main():
    ...
    # 5 Brazos con gaps bien definidos
    ...
    print("=" * 70)
    print(f"PRACTITIONER LENIENCY COMPARISON (5 ARMS)  eps={eps}  T={T}  N={N}")
    print("=" * 70)

    plt.style.use('default')
    fig: Figure
    fig, ax = plt.subplots(1, 1, figsize=(8, 6), dpi=150)  # type: ignore[assignment]
    ...
    for sc in scenarios:
        ...
        ax.set_title(sc["title"], fontsize=11, pad=6)
    ...
    fig.suptitle("Practitioner Regret Comparison (5 Arms)", fontsize=14, fontweight="bold", y=0.985)
    ...
    out = os.path.join(out_dir, "practitioner_5_arms.png")
